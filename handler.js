                    ...
                    for (let user of participants) {
                       let pp = './src/welcome.jpg'
                        try {
                            ...
                            text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'LU NGAPAIN JOIN ANJ BTW SELAMAT DATANG') :
                                (chat.sBye || this.bye || conn.bye || 'BEBAN LEFT'))
                                this.sendButtonImg(id, await(await fetch(pp)).buffer(), text, '', "ANJAY BEBAN OUT", "Nah bagus kalo out", null)
                                }
                    }
                }
                break
