...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Simple Bot Whatsapp', body: `Click Here!`, sourceUrl: 'https://instagram.com/fajar.nrd', thumbnail: data }}, options })
    }
